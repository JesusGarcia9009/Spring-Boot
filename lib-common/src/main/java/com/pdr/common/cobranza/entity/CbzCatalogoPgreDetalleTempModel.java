...
/**
 * CbzCatalogoPgreDetalleTemp generated by BS2
 */
@Entity
@Table(name = "CBZ_CATALOGO_PGRE_DETALLE_TEMP", schema = "CBZPAR")
public class CbzCatalogoPgreDetalleTempModel implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private BigDecimal idCatPgreDetalleTemp;
	...
	private String rutCobr;
	private String nombreCobr;
	private String tipoCriterio;
	private Long criterioAplicado;

	

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "ID_SEQUENCE_CAT_PGRE_DETALLE_TEMP")
	@SequenceGenerator(name = "ID_SEQUENCE_CAT_PGRE_DETALLE_TEMP", allocationSize = 1, sequenceName = "SEQ_CBZ_CATALOGO_PGRE_DETALLE_TEMP", schema = "CBZPAR")
	@Column(name = "ID_CAT_PGRE_DETALLE_TEMP", unique = true, nullable = false, precision = 22, scale = 0)
	public BigDecimal getIdCatPgreDetalleTemp() {
		return this.idCatPgreDetalleTemp;
	}

	public void setIdCatPgreDetalleTemp(BigDecimal idCatPgreDetalleTemp) {
		this.idCatPgreDetalleTemp = idCatPgreDetalleTemp;
	}
	...
	@Column(name = "RUT_COBR", length = 10)
	public String getRutCobr() {
		return this.rutCobr;
	}

	public void setRutCobr(String rutCobr) {
		this.rutCobr = rutCobr;
	}

	@Column(name = "NOMBRE_COBR", length = 200)
	public String getNombreCobr() {
		return this.nombreCobr;
	}

	public void setNombreCobr(String nombreCobr) {
		this.nombreCobr = nombreCobr;
	}
	
	@Column(name = "TIPO_CRITERIO", length = 200)
	...
	@Column(name = "CRITERIO_APLICADO", precision = 16, scale = 0)
	public Long getCriterioAplicado() {
		return this.criterioAplicado;
	}

	public void setCriterioAplicado(Long criterioAplicado) {
